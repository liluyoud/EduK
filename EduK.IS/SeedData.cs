...

                {
                    ...
                    if (lilo == null)
                    {
                        ...
                        result = userMgr.AddClaimsAsync(lilo, new Claim[]{
                            ...
                            new Claim(JwtClaimTypes.GivenName, "Liluyoud"),
                            new Claim(JwtClaimTypes.FamilyName, "Lacerda"),
                            new Claim(JwtClaimTypes.Email, "liluyoud@gmail.com"),
                            new Claim(JwtClaimTypes.PhoneNumber, "(69) 9 8114-1732"),
                            new Claim("phone", "(69) 98114-1732"),
                            new Claim(JwtClaimTypes.EmailVerified, "true", ClaimValueTypes.Boolean),
                            new Claim(JwtClaimTypes.Address, @"{ 'street_address': 'Rua João Pedro da Rocha, 2378', 'locality': 'Porto Velho - RO', 'postal_code': '76920-888', 'country': 'Brasil' }", IdentityServer4.IdentityServerConstants.ClaimValueTypes.Json)
                        }).Result;
                        if (!result.Succeeded)
                        {
                            throw new Exception(result.Errors.First().Description);
